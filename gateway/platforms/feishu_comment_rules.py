...
Config: ~/.lightning/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.lightning/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_lightning_home()`` helper (LIGHTNING_HOME-aware and
...
RULES_FILE = get_lightning_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_lightning_home() / "feishu_comment_pairing.json"
