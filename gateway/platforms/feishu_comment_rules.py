...
Config: ~/.sonic/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.sonic/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_sonic_home()`` helper (SONIC_HOME-aware and
...
RULES_FILE = get_sonic_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_sonic_home() / "feishu_comment_pairing.json"
