...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SONIC_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_sonic_dir("platforms/whatsapp/session", "whatsapp/session")
