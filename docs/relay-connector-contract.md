...
This document is the formal interface between the **Sonic gateway** (Python,
...
**per-gateway secret** (`sonic gateway enroll` → connector `/relay/enroll`, or
...
driven by the managed Portal / `sonic` CLI.
