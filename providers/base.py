...
def _profile_user_agent() -> str:
    """Return a ``sonic-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from sonic_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"sonic-cli/{_ver}"
    except Exception:
        return "sonic-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # sonic-cli UA so the catalog endpoint is reachable.
