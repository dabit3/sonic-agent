...
def _profile_user_agent() -> str:
    """Return a ``lightning-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from lightning_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"lightning-cli/{_ver}"
    except Exception:
        return "lightning-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # lightning-cli UA so the catalog endpoint is reachable.
