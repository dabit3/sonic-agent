...
Built for [Lightning Agent](https://github.com/NousResearch/lightning-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/lightning-agent/skills/creative/ascii-video`](https://github.com/NousResearch/lightning-agent/tree/main/skills/creative/ascii-video) via PR.
