...
Built for [Sonic Agent](https://github.com/dabit3/sonic-agent). Usable in any coding agent. Canonical source lives here; synced to [`dabit3/sonic-agent/skills/creative/ascii-video`](https://github.com/dabit3/sonic-agent/tree/main/skills/creative/ascii-video) via PR.
