...
class SonicACPAgent(acp.Agent):
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        # not the executor's. Also set SONIC_INTERACTIVE so approval.py
        ...
        def _run_agent() -> dict:
            ...
            previous_interactive = os.environ.get("SONIC_INTERACTIVE")
            ...
            try:
                ...
                # Restore SONIC_INTERACTIVE.
                if previous_interactive is None:
                    os.environ.pop("SONIC_INTERACTIVE", None)
                else:
                    os.environ["SONIC_INTERACTIVE"] = previous_interactive
