#!/usr/bin/env python3
"""
SWE Runner with Lightning Trajectory Format

A runner that uses Lightning-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Lightning-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Lightning-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Lightning format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Lightning-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Lightning-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Lightning Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Lightning-Agent's built-in execution environments
    and outputs trajectories in Lightning-Agent format.
    """
    ...
    def _convert_to_lightning_format(
        self,
        ...
        """
        Convert internal message format to Lightning trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Lightning trajectory format
        trajectory = self._convert_to_lightning_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Lightning trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Lightning Trajectory Format")
    print("=" * 60)
