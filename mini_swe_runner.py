#!/usr/bin/env python3
"""
SWE Runner with Sonic Trajectory Format

A runner that uses Sonic-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Sonic-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Sonic-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Sonic format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Sonic-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Sonic-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Sonic Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Sonic-Agent's built-in execution environments
    and outputs trajectories in Sonic-Agent format.
    """
    ...
    def _convert_to_sonic_format(
        ...
        """
        Convert internal message format to Sonic trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Sonic trajectory format
        trajectory = self._convert_to_sonic_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Sonic trajectory format output.
