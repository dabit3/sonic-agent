 ...
 *
 * A public install can end up with `origin=git@github.com:dabit3/sonic-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/dabit3/sonic-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/dabit3/sonic-agent'
