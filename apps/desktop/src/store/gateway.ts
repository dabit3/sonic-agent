...
const isOpen = (gateway: SonicGateway | null): boolean => gateway?.connectionState === 'open'
...
let primaryGateway: SonicGateway | null = null
let primaryProfile = 'default'

export function setPrimaryGateway(gateway: SonicGateway | null, profile = 'default'): void {
...
export function activeGateway(): SonicGateway | null {
