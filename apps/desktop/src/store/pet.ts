...
export interface PetInfo {
  ...
  // the Sonic "run" activity state uses the in-place running row).
 ...
 * SONIC_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'sonic.desktop.pet-roam.v1'
