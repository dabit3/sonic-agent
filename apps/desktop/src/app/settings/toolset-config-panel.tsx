...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/sonic'
 ...
 * log inline — the GUI equivalent of the install step `sonic tools` runs
