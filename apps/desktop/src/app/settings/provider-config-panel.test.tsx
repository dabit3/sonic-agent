...
import type { MemoryProviderConfig } from '@/types/sonic'
  ...
  const fields: MemoryProviderConfig['fields'] = [
    {
      ...
      kind: 'select',
      value: 'cloud',
      description: 'How Sonic connects to Hindsight.',
      placeholder: '',
      is_set: true,
      options: [
    ...
    { key: 'bank_id', label: 'Bank ID', kind: 'text', value: 'sonic', description: '', placeholder: '', is_set: true, options: [] },
    {
      key: 'recall_budget',
      label: 'Recall budget',
      kind: 'select',
...
describe('ProviderConfigPanel', () => {
  it('renders the declared provider fields generically', async () => {
    ...
    expect(screen.getByDisplayValue('sonic')).toBeTruthy()
