...
import { getActionStatus, getLogs, getStatus, getUsageAnalytics, restartGateway, updateSonic } from '@/sonic'
import type { ActionStatusResponse, AnalyticsResponse, StatusResponse } from '@/sonic'
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="mt-1 text-[length:var(--conversation-caption-font-size)] text-(--ui-text-tertiary)">
                          {cc.sonicActiveSessions(status.version, status.active_sessions)}
                        </div>
                      </div>
