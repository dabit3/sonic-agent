...
import type { ProjectInfo, SessionInfo } from '@/sonic'
 ...
 * repo shows its branches/worktrees even when they have no Sonic sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: SonicGitWorktree[]
): SidebarSessionGroup[] {
