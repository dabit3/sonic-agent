...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/sonic'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('sonic:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('sonic:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Sonic to
...
interface SidebarSessionsSectionProps {
  ...
  projectRepoWorktrees?: Record<string, SonicGitWorktree[]>
