import type { SonicReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SonicReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SonicReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
