...
const TAKEOVER_KEY = 'sonic.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Sonic can't clear via the API — the user
 *  sees exactly what runs instead of Sonic silently deleting their creds. */
