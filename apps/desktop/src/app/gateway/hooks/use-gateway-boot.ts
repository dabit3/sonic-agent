...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Sonic...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Sonic…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Sonic gateway". resolveGatewayWsUrl
        ...
        await callbacksRef.current.refreshSonicConfig().catch(() => undefined)
