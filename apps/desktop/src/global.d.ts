...
declare global {
  interface Window {
    sonicDesktop: {
      ...
      getConnection: (profile?: string | null) => Promise<SonicConnection>
      ...
      profile: {
        ...
        // backend under the new SONIC_HOME (reloads the window). Pass null to
      ...
      git?: {
        worktreeList: (repoPath: string) => Promise<SonicGitWorktree[]>
        worktreeAdd: (
          repoPath: string,
        ...
        branchList: (repoPath: string) => Promise<SonicGitBranch[]>
        ...
        repoStatus: (repoPath: string) => Promise<SonicRepoStatus | null>
        ...
        review: {
          list: (repoPath: string, scope: SonicReviewScope, baseRef?: null | string) => Promise<SonicReviewList>
          diff: (
            repoPath: string,
            filePath: string,
            scope: SonicReviewScope,
            baseRef?: null | string,
            staged?: boolean
          ) => Promise<string>
          ...
          shipInfo: (repoPath: string) => Promise<SonicReviewShipInfo>
...
export interface SonicGitWorktree {
  path: string
  branch: null | string
  isMain: boolean
  detached: boolean
