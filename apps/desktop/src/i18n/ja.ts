...
export const ja = defineLocale({
  ...
  settings: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Sonic がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
    ...
    gateway: {
      ...
      localDesc: 'ローカルホストでプライベートな Sonic バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
      ...
      remoteUrlDesc: 'リモートダッシュボードバックエンドのベース URL。/sonic などのパスプレフィックスもサポートしています。',
