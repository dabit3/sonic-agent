...
export const en: Translations = {
  ...
  settings: {
    ...
    providers: {
      ...
      intro: 'Sign in with a subscription — no API key to copy. Sonic runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      postSetup: step => `This provider needs an extra setup step (${step}). Run it from the CLI with sonic tools for now.`
    }
  },
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message =>
        `Sonic finished restarting the preview server${message ? `: ${message}` : ''}`,
