...
export const en: Translations = {
  ...
  boot: {
    ready: 'Sonic Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Sonic settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingSonicDesktop: 'Starting Sonic Desktop…'
    },
    errors: {
      backgroundExited: 'Sonic background process exited.',
      backgroundExitedDuringStartup: 'Sonic background process exited during startup.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Sonic defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Sonic follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Sonic is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Sonic, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Sonic checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Sonic configuration...',
    ...
    gateway: {
      ...
      intro:
        'Sonic Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Sonic backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset SONIC_DESKTOP_REMOTE_URL and SONIC_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Sonic backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Sonic backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /sonic.',
      ...
      restartingMessage: 'Sonic Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Sonic ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Sonic runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Sonic builds skills and memories for your work, they appear here.',
    share: 'Share map',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Sonic to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Sonic to generate pets.',
      backgroundHint: 'You can close this — Sonic will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Sonic desktop' },
    ...
    sonicActiveSessions: (version, count) => `Sonic ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@sonic:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Sonic environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Sonic...',
    placeholderReconnecting: 'Reconnecting to Sonic…',
    ...
    attachUrlDesc: 'Sonic will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Sonic can’t update itself from inside the app.',
  ...
  install: {
    ...
    oneTimeTitle: 'Sonic needs a one-time install',
    ...
    settingUpTitle: 'Setting up Sonic Agent',
    ...
    activeDesc:
      'This is a one-time setup. The Sonic installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Sonic Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Sonic is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Sonic…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Sonic',
    ...
    authorizeThere: 'Authorize Sonic there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Sonic there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Sonic inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Sonic will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Sonic is restarting...',
      askRestart: 'Ask Sonic to restart the server',
      lookingRestart: taskId => `Sonic is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Sonic is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Sonic finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Sonic could not restart the server.',
      stillWorking:
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Sonic is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Sonic gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.sonic/config.yaml). Sonic won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Sonic needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Sonic needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Sonic Desktop to use Save Image.',
    restartToSaveImages: 'Restart Sonic Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `sonic gateway` running?'
    }
  },
