...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        '取消設定 SONIC_DESKTOP_REMOTE_URL 和 SONIC_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew:
      '按 cron 表達式排程一個提示詞。Sonic 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  install: {
    ...
    activeDesc:
      '這是一次性設定。Sonic 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `已在瀏覽器中開啟 ${provider}。請在那裡授權 Sonic，連線會自動完成，無需複製或貼上。`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message =>
        `Sonic 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      ...
      stillWorking:
        'Sonic 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
