...
const desktopWindow = window as unknown as { sonicDesktop?: Window['sonicDesktop'] }
const initialSonicDesktop = desktopWindow.sonicDesktop

function installDesktopBridge(partial: Partial<Window['sonicDesktop']> = {}) {
  desktopWindow.sonicDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['sonicDesktop']
}
...
afterEach(() => {
  ...
  if (initialSonicDesktop) {
    desktopWindow.sonicDesktop = initialSonicDesktop
  } else {
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['sonicDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['sonicDesktop']['openExternal'] })
