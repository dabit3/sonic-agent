...
/** Why a known Sonic command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Sonic profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Sonic Agent version', surface: exec() },
