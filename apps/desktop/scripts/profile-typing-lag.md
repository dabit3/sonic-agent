...
cd apps/desktop
XCURSOR_SIZE=24 SONIC_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/sonic-typing
# → /tmp/sonic-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/sonic-typing.before.heapsnapshot
# → /tmp/sonic-typing.after.heapsnapshot
```
