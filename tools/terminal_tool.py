...
def _transform_sudo_command(command: str | None) -> tuple[str | None, str | None]:
    ...
    If SUDO_PASSWORD is not set and in interactive mode (SONIC_INTERACTIVE=1):
    ...
    if not has_configured_password and not sudo_password and env_var_enabled("SONIC_INTERACTIVE"):
