"""Shared Lightning-side execution flow for Modal transports.

This module deliberately stops at the Lightning boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"LIGHTNING_EOF_{uuid.uuid4().hex[:8]}"
