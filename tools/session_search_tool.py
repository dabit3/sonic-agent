...
the get_anchored_view / get_messages_around primitives in lightning_state.
...
# Third-party integrations tag their sessions with LIGHTNING_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from lightning_state import DEFAULT_DB_PATH
