"""
Skills configuration for Sonic Agent.
`sonic skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.sonic/config.yaml under:
...
from sonic_cli.config import cfg_get, load_config, save_config
from sonic_cli.colors import Colors, color
from sonic_cli.platforms import PLATFORMS as _PLATFORMS
