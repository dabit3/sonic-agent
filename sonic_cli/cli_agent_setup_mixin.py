"""Agent-construction and session-resume display methods for ``SonicCLI``.

Extracted from ``cli.py`` as part of the god-file decomposition campaign
(``~/.sonic/plans/god-file-decomposition.md``, Phase 4 step 2). This mixin holds
...
Behavior-neutral: every method is lifted verbatim from ``SonicCLI``. ``self.*``
...
class CLIAgentSetupMixin:
    """Agent construction + session-resume display methods for ``SonicCLI``."""
