...
Invoked by ``sonic kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Sonic Agent board.
...
def _profile_author() -> str:
    """Mirror of ``sonic_cli.kanban._profile_author``."""
    return (
