...
- Legacy session key (fallback): mint an opaque 24h key when JWT auth is
  unavailable, or when SONIC_AGENT_USE_LEGACY_SESSION_KEYS is set for
...
NOUS_LEGACY_SESSION_KEYS_ENV = "SONIC_AGENT_USE_LEGACY_SESSION_KEYS"
        ...
        try:
            ...
            if not installed:
                info["hint"] = (
                    ...
                    "pip install azure-identity  (or rely on Sonic's "
