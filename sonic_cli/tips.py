...
TIPS = [
    ...
    "Profiles scope Sonic state via SONIC_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'sonic dashboard embeds the full Sonic TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'sonic chat --ignore-user-config skips the active user config — reproducible bug reports and CI runs.',
