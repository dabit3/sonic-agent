...
def _anthropic_oauth_status() -> Dict[str, Any]:
    ...
    Sonic resolves Anthropic creds in this order at runtime:
    1. ``~/.sonic/.anthropic_oauth.json`` — Sonic-managed PKCE flow
...
async def run_import(body: ImportRequest):
    ...
    try:
        proc = _spawn_sonic_action(["import", archive], "import")
    except Exception as exc:
...
async def install_skill_hub(body: SkillInstallRequest):
    ...
    try:
        proc = _spawn_sonic_action(["skills", "install", identifier], "skills-install")
    except Exception as exc:
...
async def uninstall_skill_hub(body: SkillUninstallRequest):
    ...
    try:
        proc = _spawn_sonic_action(["skills", "uninstall", name, "--yes"], "skills-uninstall")
    except Exception as exc:
...
async def update_skills_hub():
    try:
        proc = _spawn_sonic_action(["skills", "update"], "skills-update")
    except Exception as exc:
