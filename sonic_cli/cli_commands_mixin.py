...
``cli.py``'s ``SonicCLI`` class. ``SonicCLI`` inherits ``CLICommandsMixin`` so
...
from sonic_constants import display_sonic_home, is_termux as _is_termux_environment
