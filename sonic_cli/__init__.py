"""
Sonic CLI - Unified command-line interface for Sonic Agent.

Provides subcommands for:
- sonic chat          - Interactive chat (same as ./sonic)
- sonic gateway       - Run gateway in foreground
- sonic gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `sonic setup` on a fresh Pi.
    ...
    sonic_cli/stdio.py::configure_windows_stdio() runs later from the entry
