...
Usage:
    sonic pairing list              # Show all pending + approved users
    sonic pairing approve <platform> <code>  # Approve a pairing code
    sonic pairing revoke <platform> <user_id> # Revoke user access
    sonic pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle sonic pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: sonic pairing {list|approve|revoke|clear-pending}")
        print("Run 'sonic pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.sonic/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'sonic pairing list' to see pending codes.\n")
