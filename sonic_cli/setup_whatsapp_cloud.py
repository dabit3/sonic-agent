...
Entry point: ``sonic whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``sonic_cli/main.py``).
...
Sonic gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Sonic to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Sonic needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Sonic gateway in another terminal:")
    print("         sonic gateway")
    print()
    ...
    print()
    print("  Docs: https://sonic-agent.nousresearch.com/docs/user-guide/")
