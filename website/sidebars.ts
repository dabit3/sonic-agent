...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/software-development/software-development-sonic-s6-container-supervision',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/mlops/mlops-pytorch-sonic',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-sonic-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-sonic',
        'guides/use-soul-with-sonic',
        'guides/use-voice-mode-with-sonic',
        'guides/build-a-sonic-plugin',
