...
Both publish at:
  https://lightning-agent.nousresearch.com/docs/llms.txt
  https://lightning-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://lightning-agent.nousresearch.com/docs"
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Short index: https://lightning-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
