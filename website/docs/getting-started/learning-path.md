...
:::tip Start Here
If you haven't installed Sonic Agent yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
7. [Use Voice Mode with Sonic](/docs/guides/use-voice-mode-with-sonic)
...
2. [Build a Sonic Plugin](/docs/guides/build-a-sonic-plugin)
...
Use reinforcement learning to fine-tune model behavior with Sonic Agent's built-in RL training pipeline.
...
| **Code Execution** | Run Python scripts that call Sonic tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |
