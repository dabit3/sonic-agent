...
| [`sonic-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sonic-agent) | Configure, extend, or contribute to Sonic Agent. | `autonomous-ai-agents/sonic-agent` |
| [`kanban-codex-lane`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kanban-codex-lane) | Use when a Sonic Kanban worker wants to run Codex CLI as an isolated implementation lane while Sonic keeps ownership of task lifecycle, reconciliation, testing, and handoff. | `autonomous-ai-agents/kanban-codex-lane` |
...
| [`kanban-worker`](/docs/user-guide/skills/bundled/devops/devops-kanban-worker) | Pitfalls, examples, and edge cases for Sonic Kanban workers. The lifecycle itself is auto-injected into every worker's system prompt as KANBAN_GUIDANCE (from agent/prompt_builder.py); this skill is what you load when you want deeper det... | `devops/kanban-worker` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Sonic CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-sonic-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-sonic-tui-commands) | Debug Sonic TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-sonic-tui-commands` |
| [`sonic-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-sonic-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/sonic-agent-skill-authoring` |
| [`sonic-s6-container-supervision`](/docs/user-guide/skills/bundled/software-development/software-development-sonic-s6-container-supervision) | Modify, debug, or extend the s6-overlay supervision tree inside the Sonic Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern. | `software-development/sonic-s6-container-supervision` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .sonic/plans/, no exec. | `software-development/plan` |
