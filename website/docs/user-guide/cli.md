...
<img className="docs-terminal-figure" src="/img/docs/cli-layout.svg" alt="Stylized preview of the Sonic CLI layout showing the banner, conversation area, and fixed input prompt." />
