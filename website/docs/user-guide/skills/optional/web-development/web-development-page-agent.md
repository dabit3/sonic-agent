...
- User wants **Lightning itself to drive a browser** → use Lightning' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
