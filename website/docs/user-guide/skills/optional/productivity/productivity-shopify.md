...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Lightning","productType":"Apparel","tags":["test"]}}'
```
