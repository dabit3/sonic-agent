...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Sonic Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${SONIC_HOME:-~/.sonic}/.env`:
