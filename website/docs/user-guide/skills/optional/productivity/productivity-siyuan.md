...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/productivity/siyuan` |
...
```yaml
# In ~/.lightning/config.yaml under mcp_servers:
mcp_servers:
  siyuan:
    command: npx
