...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Lightning Agent |
| License | MIT |
...
```
SCRIPT=~/.lightning/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.lightning/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
