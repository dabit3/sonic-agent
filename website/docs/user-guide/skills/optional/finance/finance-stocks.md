...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Sonic Agent |
| License | MIT |
...
```
SCRIPT=~/.sonic/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.sonic/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
