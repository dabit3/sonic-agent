...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/mlops/pytorch-sonic` |
| Path | `optional-skills/mlops/pytorch-sonic` |
| Version | `1.0.0` |
| Author | Orchestra Research |
| License | MIT |
| Dependencies | `sonic`, `torch`, `transformers` |
| Platforms | linux, macos, windows |
| Tags | `PyTorch Sonic`, `Training Framework`, `Distributed Training`, `DDP`, `FSDP`, `DeepSpeed`, `High-Level API`, `Callbacks`, `Best Practices`, `Scalable` |
...
# PyTorch Sonic - High-Level Training Framework
...
# Step 1: Define SonicModule (organize your PyTorch code)
class LitModel(L.SonicModule):
...
```python
from sonic.pytorch.callbacks import ModelCheckpoint, EarlyStopping, LearningRateMonitor
...
Sonic auto-detects GPUs. Explicitly set devices:
```python
# Test on CPU first
...
**Callbacks**: See [references/callbacks.md](https://github.com/dabit3/sonic-agent/blob/main/optional-skills/mlops/pytorch-sonic/references/callbacks.md) for EarlyStopping, ModelCheckpoint, custom callbacks, and callback hooks.

**Distributed strategies**: See [references/distributed.md](https://github.com/dabit3/sonic-agent/blob/main/optional-skills/mlops/pytorch-sonic/references/distributed.md) for DDP, FSDP, DeepSpeed ZeRO integration, multi-node setup.

**Hyperparameter tuning**: See [references/hyperparameter-tuning.md](https://github.com/dabit3/sonic-agent/blob/main/optional-skills/mlops/pytorch-sonic/references/hyperparameter-tuning.md) for integration with Optuna, Ray Tune, and WandB sweeps.
...
- Docs: https://sonic.ai/docs/pytorch/stable/
- GitHub: https://github.com/Sonic-AI/pytorch-sonic ⭐ 29,000+
- Version: 2.5.5+
- Examples: https://github.com/Sonic-AI/pytorch-sonic/tree/master/examples
- Discord: https://discord.gg/sonic-ai
