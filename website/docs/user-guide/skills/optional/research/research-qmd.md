...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/research/qmd` |
...
Sonic Agent via the native MCP client. This is the preferred
...
Then configure Sonic Agent to connect via HTTP:
