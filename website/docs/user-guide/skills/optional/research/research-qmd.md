...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/research/qmd` |
...
Lightning Agent via the native MCP client. This is the preferred
...
Then configure Lightning Agent to connect via HTTP:
