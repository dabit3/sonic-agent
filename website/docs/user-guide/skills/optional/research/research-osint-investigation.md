...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Sonic Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $SONIC_OSINT_CACHE/icij/ (default: ~/.cache/sonic-osint/icij/).
...
# Set SONIC_OSINT_UA=your-app/1.0 (your@email) to identify yourself
