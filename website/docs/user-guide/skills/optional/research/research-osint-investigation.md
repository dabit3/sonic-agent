...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Lightning Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $LIGHTNING_OSINT_CACHE/icij/ (default: ~/.cache/lightning-osint/icij/).
...
# Set LIGHTNING_OSINT_UA=your-app/1.0 (your@email) to identify yourself
