...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Sonic Agent |
| License | MIT |
...
import upstream classes into Sonic itself.
...
Open `~/.sonic/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Sonic core.
   Custom driver scripts under `~/.sonic/skills/...` are user-side and fine.
