...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Lightning Agent |
| License | MIT |
...
import upstream classes into Lightning itself.
...
```bash
mkdir -p ~/.lightning/cache/darwinian-evolver && cd ~/.lightning/cache/darwinian-evolver
...
```bash
cd ~/.lightning/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.lightning/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.lightning/skills/research/darwinian-evolver
DE_DIR=~/.lightning/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Lightning core.
   Custom driver scripts under `~/.lightning/skills/...` are user-side and fine.
