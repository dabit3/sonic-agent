...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/health/neuroskill-bci` |
...
Connect Sonic to a running [NeuroSkill](https://neuroskill.com/) instance to read
