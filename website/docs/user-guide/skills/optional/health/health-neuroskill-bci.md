...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/health/neuroskill-bci` |
...
Connect Lightning to a running [NeuroSkill](https://neuroskill.com/) instance to read
