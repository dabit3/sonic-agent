...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Lightning Agent |
| License | MIT |
...
Helper script path: `~/.lightning/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.lightning/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.lightning/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.lightning/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
