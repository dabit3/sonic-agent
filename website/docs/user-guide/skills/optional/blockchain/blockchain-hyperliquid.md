...
| | |
|---|---|
| Source | Optional — install with `lightning skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Lightning Agent |
| License | MIT |
...
The script reads `~/.lightning/.env` for two optional defaults:
...
Helper script: `~/.lightning/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.lightning/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.lightning/.env`.
...
```bash
python3 ~/.lightning/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.lightning/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
