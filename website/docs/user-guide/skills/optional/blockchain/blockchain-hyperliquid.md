...
| | |
|---|---|
| Source | Optional — install with `sonic skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Sonic Agent |
| License | MIT |
...
Helper script: `~/.sonic/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
