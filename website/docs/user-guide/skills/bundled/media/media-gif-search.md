...
Set your Tenor API key in your environment (add to `~/.lightning/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/lightning-agent/blob/main/skills/media/gif-search/url)`
