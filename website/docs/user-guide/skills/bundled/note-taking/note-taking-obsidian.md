...
The documented vault-path convention is the `OBSIDIAN_VAULT_PATH` environment variable, for example from `~/.lightning/.env`. If it is unset, use `~/Documents/Obsidian Vault`.
