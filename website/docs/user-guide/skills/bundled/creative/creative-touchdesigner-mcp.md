...
| Related skills | [`native-mcp`](/docs/user-guide/skills/bundled/mcp/mcp-native-mcp), [`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/user-guide/skills/bundled/creative/creative-manim-video), `sonic-video` |
...
3. Add `twozero_td` MCP server to Sonic config (if missing)
...
3. **Restart Sonic session** to pick up the new MCP server
