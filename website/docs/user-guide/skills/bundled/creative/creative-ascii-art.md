...
```bash
python3 -m pyfiglet "SONIC" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SONIC&font=Slant" | boxes -d stone
```
