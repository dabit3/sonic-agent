...
```bash
python3 -m pyfiglet "LIGHTNING" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LIGHTNING&font=Slant" | boxes -d stone
```
