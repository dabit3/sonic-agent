...
**MarkdownV2 fallback.** When the rich path is disabled or unavailable, Sonic converts markdown to MarkdownV2. Since MarkdownV2 has no native table syntax, pipe tables are normalized:
