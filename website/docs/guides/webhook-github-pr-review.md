...
Load a [Sonic skill](/user-guide/features/skills) to give the agent a consistent review persona. Add `skills` to your route inside `platforms.webhook.extra.routes` in `config.yaml`:
...
- **[Build a Plugin](/guides/build-a-sonic-plugin)** — package review logic into a shareable plugin
