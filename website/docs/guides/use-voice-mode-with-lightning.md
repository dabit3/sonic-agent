---
sidebar_position: 8
title: "Use Voice Mode with Lightning"
description: "A practical guide to setting up and using Lightning voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Lightning
...
- you want Lightning sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Lightning.
...
## Step 1: make sure normal Lightning works first
...
Lightning supports both local and cloud speech stacks.
...
4. Lightning transcribes and responds
...
- asking Lightning to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Lightning loop.

## Tuning CLI behavior

### Silence threshold

If Lightning starts/stops too aggressively, tune:
...
Lightning stays a normal chat bot, but can speak replies.
...
- you want Lightning to function like a portable research or ops assistant
...
Lightning joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Lightning detects speech boundaries
- transcripts are posted in the associated text channel
- Lightning responds in text and audio
...
1. get text Lightning working
2. install `lightning-agent[voice]`
