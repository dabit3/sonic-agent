...
Copy-paste recipes for common automation patterns. Each template uses Sonic's built-in [cron scheduler](/user-guide/features/cron) for time-based triggers and [webhook platform](/user-guide/messaging/webhooks) for event-driven triggers.
