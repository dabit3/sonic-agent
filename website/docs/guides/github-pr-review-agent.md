...
- **Sonic Agent installed** — see the [Installation guide](/getting-started/installation)
...
- **[Build a Plugin](/guides/build-a-sonic-plugin)** — wrap the review logic into a shareable plugin
