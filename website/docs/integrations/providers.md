...
**For full details:** see the dedicated [Nous Portal integration page](/docs/integrations/nous-portal) (what's in the subscription, model catalog, troubleshooting) and the step-by-step [Run Sonic with Nous Portal guide](/docs/guides/run-sonic-with-nous-portal).
