...
See [Building a Sonic Plugin](/guides/build-a-sonic-plugin#distribute-via-pip) for the full entry-points setup.
...
- [Building a Sonic Plugin](/guides/build-a-sonic-plugin) — general plugin authoring
