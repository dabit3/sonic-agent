...
const config: Config = {
  ...
  url: 'https://lightning-agent.nousresearch.com',
  baseUrl: '/docs/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://lightning-agent.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://github.com/dabit3/sonic-agent/releases/latest' },
