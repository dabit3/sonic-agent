...
将当前 profile 的 `config.yaml`、`.env` 和 `SOUL.md` 复制到新 profile。API 密钥和模型相同，但会话和记忆是全新的。编辑 `~/.sonic/profiles/work/.env` 可使用不同的 API 密钥，编辑 `~/.sonic/profiles/work/SOUL.md` 可设置不同的人格。
