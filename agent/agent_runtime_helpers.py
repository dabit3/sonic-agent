...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Sonic-Session-Id header), and an
        ...
        if env_var_enabled("SONIC_DUMP_REQUEST_STDOUT"):
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    if hasattr(agent, "context_compressor") and agent.context_compressor:
        ...
        try:
            from sonic_cli.config import load_config, get_compatible_custom_providers
            _sm_cfg = load_config()
