...
(3 SDK retries x 3 Lightning retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_lightning_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".lightning")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Lightning, ...) behind one endpoint.  A 429 can mean either:
