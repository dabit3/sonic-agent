...
Follow the Sonic skill-authoring standards exactly. These are the same
...
- version: 0.1.0
- author: always the literal value `Sonic`. NEVER fill it from the host
  ...
  a privacy leak the user never opted into; the skill names itself as Sonic.
