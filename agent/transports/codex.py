...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Sonic's web-provider config and
        ...
        # native search engine for xAI sessions instead of Sonic's
        # configured web provider (Tavily/etc.), and those results bypass
        # Sonic's tool-trace / citation plumbing (they arrive baked into the
