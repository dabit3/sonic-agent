...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Sonic/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Sonic'
    ...
    # is stricter (low/high). Clamp Sonic's wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Sonic-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Sonic-internal scaffolding markers (``_``-prefixed).
