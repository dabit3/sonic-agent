...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_chat_completions():
        ...
        _base_timeout = (
            ...
            else env_float("SONIC_API_TIMEOUT", 1800.0)
        )
        ...
        if _provider_timeout_cfg is not None:
            ...
            _stream_read_timeout = env_float("SONIC_STREAM_READ_TIMEOUT", 120.0)
    ...
    if _cfg_stale is not None:
        ...
        _stream_stale_timeout_base = env_float("SONIC_STREAM_STALE_TIMEOUT", 180.0)
