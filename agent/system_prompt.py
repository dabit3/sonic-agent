...
upstream prefix cache warm.  See ``lightning-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Lightning never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want LIGHTNING_HOME persona while keeping
    ...
    # Pointer to the lightning-agent skill + docs for user questions about Lightning itself.
    stable_parts.append(LIGHTNING_AGENT_HELP_GUIDANCE)
    ...
    # LIGHTNING_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the lightning-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Lightning never rebuilds or reinjects parts of it
