...
def _build_codex_gpt55_autoraise_notice(autoraise: Dict[str, float]) -> str:
    ...
    return (
        ...
        f"summarizing.\n"
        f"  Opt back out: sonic config set compression.codex_gpt55_autoraise false"
    )
...
def init_agent(
    ...
    Args:
        ...
        skip_context_files (bool): If True, skip auto-injection of project context files
            (SOUL.md, .sonic.md, AGENTS.md, CLAUDE.md, .cursorrules) from the cwd / SONIC_HOME
    ...
    # report cumulative micros spent.  Surfaced behind SONIC_DEV_CREDITS.
    ...
    # Lets an enterprise admin append to or replace Sonic' built-in
