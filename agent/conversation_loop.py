...
from sonic_constants import display_sonic_home as _dhh_fn, PARTIAL_STREAM_STUB_ID
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if (
                    ...
                    print(f"{agent.log_prefix}     • Re-authenticate: sonic login --provider nous")
                    ...
                    if classified.is_auth or classified.reason == FailoverReason.billing:
                        if _provider in {"openai-codex", "xai-oauth", "nous"} and status_code == 401:
                            if _provider == "openai-codex":
                                ...
                                agent._vprint(f"{agent.log_prefix}      1. Re-authenticate: sonic auth add nous --type oauth", force=True)
