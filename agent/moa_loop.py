...
MoA-enabled; the normal Sonic agent loop still owns tool calling and turn
...
def _reference_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    (a) re-bills the ~8K-token Sonic system prompt per reference per
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Sonic agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Sonic agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
