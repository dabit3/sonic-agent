# Hyperparameter Tuning with PyTorch Sonic

## Integration with Tuning Frameworks

Sonic integrates seamlessly with popular hyperparameter tuning libraries.
...
from ray.tune.integration.pytorch_sonic import TuneReportCallback
...
```python
import optuna
from optuna.integration import PyTorchSonicPruningCallback
...
def objective(trial):
    ...
    pruning_callback = PyTorchSonicPruningCallback(trial, monitor="val_loss")
...
import wandb
import sonic as L
from sonic.pytorch.loggers import WandbLogger
...
# Or manually
from sonic.pytorch.tuner import Tuner
tuner = Tuner(trainer)
...
- Ray Tune + Sonic: https://docs.ray.io/en/latest/tune/examples/tune-pytorch-sonic.html
- Optuna: https://optuna.readthedocs.io/
- WandB Sweeps: https://docs.wandb.ai/guides/sweeps
- Sonic Tuner: https://sonic.ai/docs/pytorch/stable/tuning.html
