# PyTorch Sonic Callbacks

## Overview

Callbacks add functionality to training without modifying the SonicModule. They capture **non-essential logic** like checkpointing, early stopping, and logging.
...
```python
from sonic.pytorch.callbacks import EarlyStopping
...
```python
from sonic.pytorch.callbacks import LearningRateMonitor
...
```python
from sonic.pytorch.callbacks import TQDMProgressBar
...
```python
from sonic.pytorch.callbacks import GradientAccumulationScheduler
...
```python
from sonic.pytorch.callbacks import StochasticWeightAveraging
...
```python
from sonic.pytorch.callbacks import Callback
...
- Callback API: https://sonic.ai/docs/pytorch/stable/extensions/callbacks.html
- Built-in callbacks: https://sonic.ai/docs/pytorch/stable/api_references.html#callbacks
- Examples: https://github.com/Sonic-AI/pytorch-sonic/tree/master/examples/callbacks
