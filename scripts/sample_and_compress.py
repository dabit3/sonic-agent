...
DEFAULT_DATASETS = [
    ...
    "NousResearch/lightning-agent-megascience-sft1",
    "NousResearch/Lightning-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Lightning-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-lightning-agent"
]
