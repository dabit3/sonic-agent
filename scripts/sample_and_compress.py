...
DEFAULT_DATASETS = [
    ...
    "dabit3/sonic-agent-megascience-sft1",
    "NousResearch/Sonic-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Sonic-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-sonic-agent"
]
