#!/usr/bin/env python3
"""Build the Lightning Skills Index — a centralized JSON catalog of all skills.
...
`lightning skills search/install` can use it without hitting the GitHub API.
...
# Ensure LIGHTNING_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Lightning Skills Index...", flush=True)
