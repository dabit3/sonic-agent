#!/usr/bin/env python3
"""Build the Sonic Skills Index — a centralized JSON catalog of all skills.
...
`sonic skills search/install` can use it without hitting the GitHub API.
...
# Ensure SONIC_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Sonic Skills Index...", flush=True)
