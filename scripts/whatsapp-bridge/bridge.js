...
const IMAGE_CACHE_DIR = path.join(process.env.HOME || '~', '.sonic', 'image_cache');
const DOCUMENT_CACHE_DIR = path.join(process.env.HOME || '~', '.sonic', 'document_cache');
const AUDIO_CACHE_DIR = path.join(process.env.HOME || '~', '.sonic', 'audio_cache');
