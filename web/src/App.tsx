...
const SIDEBAR_COLLAPSED_KEY = "sonic-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="sonic-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="sonic-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateSonic,
      runningLabel: t.status.updatingSonic,
      spin: false,
    },
  ];
