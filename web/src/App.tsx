          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="lightning-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="lightning-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateLightning,
      runningLabel: t.status.updatingLightning,
      spin: false,
    },
  ];
