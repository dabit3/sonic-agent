/**
 * Sonic Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SONIC_PLUGIN_SDK__`` and
 * ``window.__SONIC_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SONIC_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SonicPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@sonic/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SONIC_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SONIC_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SONIC_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SonicPluginSDK {
...
declare global {
  interface Window {
    __SONIC_PLUGIN_SDK__?: SonicPluginSDK;
    __SONIC_PLUGINS__?: PluginRegistry;
  }
}
