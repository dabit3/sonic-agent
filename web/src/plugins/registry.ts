 ...
 *
 * Plugins call window.__SONIC_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SONIC_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SONIC_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SONIC_PLUGIN_SDK__ = {
    ...
    // window.__SONIC_SESSION_TOKEN__ directly.
    authedFetch,
