 ...
 * `window.__LIGHTNING_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Lightning brand in the top bar
 ...
 *  `window.__LIGHTNING_PLUGINS__.registerSlot(...)`.
 *
