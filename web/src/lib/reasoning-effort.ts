 ...
 *
 * Values mirror sonic_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Sonic default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Sonic' default when unset). */
