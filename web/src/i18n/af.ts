...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateSonic: "Werk Sonic op",
    updatingSonic: "Besig om Sonic op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Sonic-inproppe op (`sonic plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.sonic/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.sonic/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.sonic/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Sonic-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Sonic-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Sonic meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Sonic 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Sonic skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
