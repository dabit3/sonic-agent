...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Sonic plugins (`sonic plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.sonic/plugins/?",
    removeHint: "Only user-installed plugins under ~/.sonic/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.sonic/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Sonic doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Sonic badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Sonic session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Sonic more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Sonic sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Sonic is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
