...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateLightning: "Aggiorna Lightning",
    updatingLightning: "Aggiornamento di Lightning…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Lightning (parità con `lightning plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.lightning/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.lightning/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.lightning/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Lightning da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Lightning in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Lightning di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Lightning rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Lightning sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
