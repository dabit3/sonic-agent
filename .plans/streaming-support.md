# Streaming LLM Response Support for Sonic Agent
...
```
SONIC_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SONIC_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `sonic_cli/config.py` | 1 | +streaming config defaults |
