# Streaming LLM Response Support for Lightning Agent
...
```
LIGHTNING_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LIGHTNING_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `lightning_cli/config.py` | 1 | +streaming config defaults |
...
LIGHTNING_STREAMING_ENABLED=true
```
