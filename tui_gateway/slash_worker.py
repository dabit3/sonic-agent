...
def _env_float(name: str, default: float) -> float:
    ...
    import time on a typo (e.g. ``SONIC_SLASH_WATCHDOG_POLL_S=2s``) and kill
...
_WATCHDOG_POLL_S = max(0.05, _env_float("SONIC_SLASH_WATCHDOG_POLL_S", 2.0))
_ORPHAN_GRACE_S = max(0.0, _env_float("SONIC_SLASH_WATCHDOG_GRACE_S", 5.0))
