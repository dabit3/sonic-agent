...
def _apply_model_switch(sid: str, session: dict, raw_input: str) -> dict:
    ...
    os.environ["SONIC_MODEL"] = result.new_model
    os.environ["SONIC_INFERENCE_MODEL"] = result.new_model
    ...
    # in config or env.
    #
    # SONIC_TUI_PROVIDER is the canonical "explicit-this-process" carrier
    ...
    if result.target_provider:
        os.environ["SONIC_INFERENCE_PROVIDER"] = result.target_provider
        os.environ["SONIC_TUI_PROVIDER"] = result.target_provider
    if persist_global:
