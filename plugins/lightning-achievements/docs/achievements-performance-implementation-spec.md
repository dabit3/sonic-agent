# Lightning Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.lightning/plugins/lightning-achievements/state.json` (existing unlock state)
  - `~/.lightning/plugins/lightning-achievements/scan_snapshot.json` (new)
  - `~/.lightning/plugins/lightning-achievements/scan_checkpoint.json` (new)
