# Lightning Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.lightning/plugins/lightning-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.lightning/plugins/lightning-achievements/scan_checkpoint.json`.
