...
``_check_spotify_available()`` — when the user has not run ``sonic auth
spotify``, the tools remain registered (so they appear in ``sonic
...
The Spotify auth flow (``sonic auth spotify``), CLI plumbing, and docs
