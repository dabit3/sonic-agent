...
required — uses aiohttp which is already a Sonic dependency.
...
def interactive_setup() -> None:
    ...
    ``sonic_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # sonic_cli/setup.py::_setup_mattermost function.
