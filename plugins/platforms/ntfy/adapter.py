    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "sonic-in"              # subscribe topic (incoming)
          publish_topic: "sonic-out"     # optional — defaults to topic
...
_ECHO_TAG = "sonic-agent"  # tag added to outgoing messages for echo-loop prevention
