...
# dict in sonic_cli/gateway.py, and the _send_dingtalk dispatch in
...
def interactive_setup() -> None:
    ...
    Replaces sonic_cli/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in sonic_cli/gateway.py. CLI helpers are
