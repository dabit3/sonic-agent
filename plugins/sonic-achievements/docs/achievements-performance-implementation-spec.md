# Sonic Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.sonic/plugins/sonic-achievements/state.json` (existing unlock state)
  - `~/.sonic/plugins/sonic-achievements/scan_snapshot.json` (new)
  - `~/.sonic/plugins/sonic-achievements/scan_checkpoint.json` (new)
