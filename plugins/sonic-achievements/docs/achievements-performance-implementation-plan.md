# Sonic Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.sonic/plugins/sonic-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.sonic/plugins/sonic-achievements/scan_checkpoint.json`.
