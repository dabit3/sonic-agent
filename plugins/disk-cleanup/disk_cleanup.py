...
def quick() -> Dict[str, Any]:
    ...
    # Remove empty dirs under SONIC_HOME, but never recurse into known
    # durable state trees.  Some installs place the Sonic checkout, venv,
    # and desktop build under SONIC_HOME; a full rglob over that tree can
