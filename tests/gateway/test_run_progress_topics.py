...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.sonic/sonic-agent/.worktrees/sonic-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
