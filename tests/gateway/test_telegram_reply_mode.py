...
class TestTelegramYamlConfigLoading:
    ...
    def test_top_level_reply_to_mode_off(self, tmp_path, monkeypatch):
        ...
        sonic_home = self._write_config(tmp_path, "telegram:\n  reply_to_mode: off\n")
...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/dabit3/sonic-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via Sonic-created DM topic
