...
def _run_setup_feishu(
    *,
    ...
    with patch("sonic_cli.config.save_env_value", side_effect=mock_save), \
         patch("sonic_cli.config.get_env_value", side_effect=mock_get), \
         patch("sonic_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("sonic_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("sonic_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("sonic_cli.cli_output.print_header"), \
         patch("sonic_cli.cli_output.print_info"), \
         patch("sonic_cli.cli_output.print_success"), \
         patch("sonic_cli.cli_output.print_warning"), \
         patch("sonic_cli.cli_output.print_error"), \
