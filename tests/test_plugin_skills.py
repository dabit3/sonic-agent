...
- lightning_cli/plugins register_skill API + registry
...
class TestPluginSkillRegistry:
    ...
    def pm(self, monkeypatch):
        ...
        from lightning_cli.plugins import PluginManager
...
class TestSkillViewPluginGuards:
    ...
    def test_disabled_plugin(self, tmp_path, monkeypatch):
        ...
        self._reg(tmp_path, "---\nname: foo\n---\nBody.\n")
        monkeypatch.setattr("lightning_cli.plugins._get_disabled_plugins", lambda: {"myplugin"})
