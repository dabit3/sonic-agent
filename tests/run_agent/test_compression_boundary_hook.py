...
old_session_id=<old>). This lets plugin engines (e.g. lightning-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See lightning-lcm#68: after Lightning compresses and mints a new physical session,
