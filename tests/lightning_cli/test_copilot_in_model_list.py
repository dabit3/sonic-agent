...
def test_copilot_picker_keeps_curated_copilot_models_when_live_catalog_unavailable():
    with patch("agent.models_dev.fetch_models_dev", return_value={}), \
         patch("lightning_cli.models._resolve_copilot_catalog_api_key", return_value="gh-token"), \
...
def test_copilot_picker_uses_live_catalog_when_available():
    ...
    with patch("agent.models_dev.fetch_models_dev", return_value={}), \
         patch("lightning_cli.models._resolve_copilot_catalog_api_key", return_value="gh-token"), \
         patch("lightning_cli.models._fetch_github_models", return_value=live_models):
        providers = list_authenticated_providers(current_provider="openrouter", max_models=50)
