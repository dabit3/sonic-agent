...
The main() function in lightning_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `lightning -c model`
...
def _build_parser():
    """Build a minimal replica of the lightning top-level parser."""
