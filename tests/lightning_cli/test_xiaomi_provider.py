...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from lightning_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in LIGHTNING_OVERLAYS
        overlay = LIGHTNING_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify lightning doctor recognizes Xiaomi env vars."""
