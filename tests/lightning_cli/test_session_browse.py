"""Tests for the interactive session browser (`lightning sessions browse`).
...
from lightning_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """lightning sessions browse should be parseable."""
        from lightning_cli.main import main as _main_entry
