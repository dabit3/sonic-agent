"""Tests for `lightning curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import lightning_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated LIGHTNING_HOME with real agent-created skills on disk."""
    ...
    from lightning_cli import curator as curator_cli
