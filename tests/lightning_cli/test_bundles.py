"""Tests for lightning_cli/bundles.py — the `lightning bundles` CLI subcommand."""
...
from lightning_cli.bundles import (
    bundles_command,
    register_cli,
)
...
def bundles_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("LIGHTNING_BUNDLES_DIR", str(bundles_dir))
