"""Tests for `sonic curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import sonic_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SONIC_HOME with real agent-created skills on disk."""
    home = tmp_path / ".sonic"
    skills = home / "skills"
    ...
    from sonic_cli import curator as curator_cli
