...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    import sonic_cli.banner as _banner
    import model_tools as _mt
    import tools.mcp_tool as _mcp

    _banner._latest_release_cache = None
    tag_url = ("v2026.4.23", "https://github.com/dabit3/sonic-agent/releases/tag/v2026.4.23")
    ...
    assert "Sonic Agent v" in raw, "Version label missing from title"
