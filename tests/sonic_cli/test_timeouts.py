...
def test_resolved_api_call_timeout_priority(monkeypatch, tmp_path):
          ...
          openrouter:
            ...
            models:
              openai/gpt-4o-mini:
                timeout_seconds: 42
        """)
    monkeypatch.setenv("SONIC_API_TIMEOUT", "999")
    ...
    from sonic_cli import timeouts as to_mod
    ...
    monkeypatch.delenv("SONIC_API_TIMEOUT", raising=False)
          ...
          openai-codex:
            ...
            models:
              gpt-5.4:
                stale_timeout_seconds: 1800
        """)
    monkeypatch.setenv("SONIC_API_CALL_STALE_TIMEOUT", "999")
