...
The main() function in sonic_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `sonic -c model`
...
def _build_parser():
    """Build a minimal replica of the sonic top-level parser."""
