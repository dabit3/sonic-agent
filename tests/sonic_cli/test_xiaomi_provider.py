...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from sonic_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SONIC_OVERLAYS
        overlay = SONIC_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify sonic doctor recognizes Xiaomi env vars."""
