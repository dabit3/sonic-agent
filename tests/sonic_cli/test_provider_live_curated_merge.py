...
class TestGenericProviderLiveCuratedMerge:
    ...
    def test_live_first_for_opencode_zen(self):
        ...
        with (
            ...
            patch.dict("sonic_cli.models._PROVIDER_MODELS", {"opencode-zen": curated}),
        ):
    ...
    def test_no_models_dropped_either_direction(self):
        ...
        with (
            ...
            patch.dict("sonic_cli.models._PROVIDER_MODELS", {"zai": ["c", "b"]}),
        ):
        ...
        with (
            ...
            patch.dict("sonic_cli.models._PROVIDER_MODELS", {"opencode-zen": ["c", "b"]}),
        ):
