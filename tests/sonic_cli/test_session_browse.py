"""Tests for the interactive session browser (`sonic sessions browse`).
...
from sonic_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """sonic sessions browse should be parseable."""
        from sonic_cli.main import main as _main_entry
