...
Covers:
- Defense 1: gateway stop/restart refuse when SONIC_IN_GATEWAY=1
...
class TestGatewaySelfTargetingGuard:
    """Verify sonic gateway stop/restart refuse when SONIC_IN_GATEWAY=1."""

    def test_stop_refuses_inside_gateway(self, monkeypatch):
        monkeypatch.setenv("SONIC_IN_GATEWAY", "1")
    ...
    def test_stop_allows_outside_gateway(self, monkeypatch):
        monkeypatch.delenv("SONIC_IN_GATEWAY", raising=False)
        from sonic_cli.gateway import gateway_command
        args = Namespace(gateway_command="stop", all=False, system=False)
