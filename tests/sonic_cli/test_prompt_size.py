"""Tests for the ``sonic prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from sonic_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(sonic_home, memory_text="", user_text=""):
    mem_dir = sonic_home / "memories"
...
def _seed_skill(sonic_home, name, description):
    skill_dir = sonic_home / "skills" / "demo" / name
