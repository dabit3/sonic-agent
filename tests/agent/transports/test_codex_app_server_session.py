...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_lightning_tools_auto_accepts(self):
        """When codex elicits on behalf of lightning-tools (our own callback),
