...
def _load_plugin_router():
    ...
    mod_name = "lightning_dashboard_plugin_kanban_worker_runs_test"
...
def test_inspect_run_dead_pid(client, monkeypatch):
    ...
    plugin_mod_name = "lightning_dashboard_plugin_kanban_worker_runs_test"
