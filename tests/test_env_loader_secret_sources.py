"""Tests for the secret-source tracking in ``lightning_cli.env_loader``.

These cover the small public surface that lets `lightning model` / `lightning setup`
...
from lightning_cli import env_loader  # noqa: E402
