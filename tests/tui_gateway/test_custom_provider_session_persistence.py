...
"No LLM provider configured. Run `sonic model`..." (resume failed) or
...
import sonic_cli.runtime_provider as rp
...
def _make_agent_with_override(override, monkeypatch, config, model_cfg=None):
    ...
    # Keep credential-pool resolution off the developer's real SONIC home.
