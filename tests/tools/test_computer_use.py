...
def _reset_backend():
    ...
    with patch.dict(os.environ, {"SONIC_COMPUTER_USE_BACKEND": "noop"}, clear=False):
        yield
    reset_backend_for_tests()
...
class TestCuaEnvironmentScrubbing:
    ...
    def test_cua_session_sanitizes_provider_env_vars(self):
        ...
        The cua-driver MCP subprocess should not inherit Sonic-managed
...
class TestSessionLifecycle:
    ...
    def test_session_id_format(self):
        ...
        assert len(backend._session_id) == len("sonic-") + 12
