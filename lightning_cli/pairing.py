...
Usage:
    lightning pairing list              # Show all pending + approved users
    lightning pairing approve <platform> <code>  # Approve a pairing code
    lightning pairing revoke <platform> <user_id> # Revoke user access
    lightning pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle lightning pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: lightning pairing {list|approve|revoke|clear-pending}")
        print("Run 'lightning pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.lightning/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'lightning pairing list' to see pending codes.\n")
