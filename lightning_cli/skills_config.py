"""
Skills configuration for Lightning Agent.
`lightning skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.lightning/config.yaml under:
...
from lightning_cli.config import cfg_get, load_config, save_config
from lightning_cli.colors import Colors, color
from lightning_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `lightning skills`."""
    from lightning_cli.curses_ui import curses_checklist
