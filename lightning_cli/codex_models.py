...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # in lightning_cli/models.py — only the openai-codex (OAuth) provider
...
_FORWARD_COMPAT_TEMPLATE_MODELS: List[tuple[str, tuple[str, ...]]] = [
    ...
    # entitlement; Lightning does not.
...
def _read_cache_models(codex_home: Path) -> List[str]:
    ...
    if isinstance(entries, list):
        for item in entries:
            ...
            # public OpenAI API, while Lightning openai-codex talks to the same
