"""Lightning CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.lightning/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Lightning Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚡ Lightning "       # Response box header label
...
.. code-block:: python
    ...
    from lightning_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Lightning Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.lightning/skins/
...
Drop a YAML file in ``~/.lightning/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces LIGHTNING_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces LIGHTNING_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Lightning — speed-first electric theme",
        "colors": {
            ...
            "status_bar_bg": "#0a0a1e",
            "session_label": "#00BFFF",
            "session_border": "#0088AA",
        },
        "spinner": {
            # Empty = use hardcoded defaults in display.py
        },
        "branding": {
            "agent_name": "Lightning Agent",
            "welcome": "Welcome to Lightning Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚡",
            "response_label": " ⚡ Lightning ",
            "prompt_symbol": "❯",
...
def _skins_dir() -> Path:
    ...
    return get_lightning_home() / "skins"
