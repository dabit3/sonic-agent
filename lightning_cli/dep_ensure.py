...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_lightning_agent_browser()
    ),
...
def _has_lightning_agent_browser() -> bool:
    ...
    # install.sh installs globally into $LIGHTNING_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-LightningHome", str(get_lightning_home()),
        ]
    else:
